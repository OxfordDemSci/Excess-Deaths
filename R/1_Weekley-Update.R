...
#males
males.deaths.update <- data.table(read_excel('Data/Update data/publishedweek222020.xlsx',sheet="Weekly figures 2020",range = 'B44:BC63',
                                             col_names = F))
males.deaths.update[,sex:='m']
females.deaths.update <- data.table(read_excel('Data/Update data/publishedweek222020.xlsx',sheet="Weekly figures 2020",range = 'B66:BC85',
                                               col_names = F))
