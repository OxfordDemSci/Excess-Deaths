...
#females
(ex.2020.1$ex[1] + lifetable.qx(x,qx.females.2020,sex = 'F')$ex[1])/2

#males
(ex.2020.1$ex[2] + lifetable.qx(x,qx.males.2020,sex = 'M')$ex[1])/2


##### Scenario 2. deaths go back to below 10%
#females
(ex.2020.1$ex[1] + lifetable.mx(x,mx = qxax2mx(qx =qx.females.2020*.9,x = x,sex = 'F'),sex = 'F')$ex[1])/2

#males
(ex.2020.1$ex[2] + lifetable.mx(x,mx = qxax2mx(qx =qx.males.2020*.9,x = x,sex = 'M'),sex = 'M')$ex[1])/2

                    

##### Scenario 2. deaths go back to above 10%
#females
(ex.2020.1$ex[1] + lifetable.mx(x,mx = qxax2mx(qx =qx.females.2020*1.1,x = x,sex = 'F'),sex = 'F')$ex[1])/2

#males
(ex.2020.1$ex[2] + lifetable.mx(x,mx = qxax2mx(qx =qx.males.2020*1.1,x = x,sex = 'M'),sex = 'M')$ex[1])/2
